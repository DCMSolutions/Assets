...
import { CategoriesTableRecord } from "./columns";
...
export function CategoriesDataTable<TData extends CategoriesTableRecord>({
  columns,
  data,
  ...
  const handleRowClick = (row: Row<TData>) => {
    ...
    linked(`/assets/categories/${row.getValue("id")}`);
  };
